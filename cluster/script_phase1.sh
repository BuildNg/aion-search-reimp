...
test "$(grep -cve '^[[:space:]]*$' "$RUN_ROOT/data/phase1/gpt41mini_freeform_64_v1.jsonl")" -eq 64
...
cd "$RUN_ROOT"
"$ENV_ROOT/bin/python" -u scripts/run_phase1_cluster.py
