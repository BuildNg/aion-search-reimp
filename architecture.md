...
| `spec_probes/paired.py` | paired image-only, spectrum-only, and fusion spec-z comparison using the existing split, ridge, and metric code | data downloads, model-specific inference |
